...
import cv2
import numpy as np
from B_Basics.A_CustomClasses.Toggle import ToggleImg
from B_Basics.A_CustomClasses.Slider import Slider
...
# Slider
sliderList = [Slider((104, 424 + 0 * 65), startValue=0, widthSlider=180, fontSize=40, max=179),
              Slider((104, 424 + 1 * 65), startValue=179, widthSlider=180, fontSize=40, max=179),
              Slider((104, 424 + 2 * 65), startValue=0, widthSlider=180, fontSize=40, max=255),
              Slider((104, 424 + 3 * 65), startValue=255, widthSlider=180, fontSize=40, max=255)]
